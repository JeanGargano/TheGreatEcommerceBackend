...
public class CategoriaServiceImp implements ICategoriaService{
    ...
    public String crearCategoria(CategoriaModel categoria) {
        ...
        if(CategoriasExistentes.isEmpty()){
            ...
            for (CategoriaModel i : CategoriasExistentes) {
                if (categoria.getIdCategoria().equals(i.getIdCategoria())) {

                    textoRespuesta = "La Categoria con ID: " + categoria.getIdCategoria() + ", Ya se encuentra creado.";
